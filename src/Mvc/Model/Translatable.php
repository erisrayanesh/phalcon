...
trait Translatable
{
    ...
    public function getTranslationModelNameDefault()
    {
        ...
        return $modelName . config('app.translation_suffix', 'Translation');
    }
    ...
    {
        return config('app.translation_model_namespace');
    }
    ...
    {
        return $this->localeKey ?: config('app.locale_key', 'locale');
    }
    ...
    {
        return $this->useFallback() && config('app.use_property_fallback', false);
    }
    ...
    private function useFallback()
    {
        ...
        return config('app.use_fallback');
    }
    ...
    {
        $localesConfig = (array) config('app.languages');
        ...
        return array_keys($localesConfig);
    }
    ...
    public function scopeWithTranslation(Builder $query)
    {
        $query->with([
            'translations' => function (Relation $query) {
                if ($this->useFallback()) {
                    $locales = array_unique([$this->locale(), $this->getFallbackLocale()]);
...
//                    ->where($translationTable.'.'.$localeKey, $this->locale());
    ...
    {
        return config('app.to_array_always_loads_translations', true);
    }
